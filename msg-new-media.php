...
<html lang="pt-br">
  ...
  <body>
    ...
    <div class="alert alert-success alert-dismissible fade in col-lg-8" role="alert">
      ...
      <h4>Item de mídia Cadastrado</h4>
      <p>Muito bem o item foi cadastrado.<br>
        <small class="help-block"><i>Escolha uma das opções abaixo, ou utilize o menu ao lado para continuar...</i></small>  
      </p>
      <p>
        <a href="new-media.php" class="btn btn-success">Cadastrar novo item</a>
        <a href="view-media.php" class="btn btn-default">Ver itens cadastrados</a>
      </p>
    </div>
