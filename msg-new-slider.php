...
<html lang="pt-br">
  ...
  <body>
    ...
    <div class="alert alert-success alert-dismissible fade in col-lg-8" role="alert">
      ...
      <h4>Slider Cadastrado</h4>
      <p>Muito bem o slider foi cadastrado.<br>
        <small class="help-block"><i>Escolha uma das opções abaixo, ou utilize o menu ao lado para continuar...</i></small>  
      </p>
      <p>
        <a href="new-slider-admin.php" class="btn btn-success">Cadastrar novo slider</a>
        <a href="slider-admin.php" class="btn btn-default">Ver sliders cadastrados</a>
      </p>
    </div>
