...
<html lang="pt-br">
  ...
  <body>
    ...
    <div class="alert alert-success alert-dismissible fade in col-lg-8" role="alert">
      ...
      <h4>Destaque Cadastrado</h4>
      <p>Muito bem o destaque foi cadastrado.<br>
        <small class="help-block"><i>Escolha uma das opções abaixo, ou utilize o menu ao lado para continuar...</i></small>  
      </p>
      <p>
        <a href="new-hot-admin.php" class="btn btn-success">Cadastrar novo destaque</a>
        <a href="hot-admin.php" class="btn btn-default">Ver destaques cadastrados</a>
      </p>
    </div>
