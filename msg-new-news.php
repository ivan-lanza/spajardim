...
<html lang="pt-br">
  ...
  <body>
    ...
    <div class="alert alert-success alert-dismissible fade in col-lg-8" role="alert">
      ...
      <h4>Novidade Cadastrada</h4>
      <p>Muito bem a novidade foi cadastrada.<br>
        <small class="help-block"><i>Escolha uma das opções abaixo, ou utilize o menu ao lado para continuar...</i></small>  
      </p>
      <p>
        <a href="new-news-admin.php" class="btn btn-success">Cadastrar novidade</a>
        <a href="news-admin.php" class="btn btn-default">Ver novidades cadastradas</a>
      </p>
    </div>
