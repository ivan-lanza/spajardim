...
<html lang="pt-br">
  ...
  <body>
    ...
    <div class="alert alert-success alert-dismissible fade in col-lg-8" role="alert">
      ...
      <h4>Vídeo Cadastrado</h4>
      <p>Muito bem o vídeo foi cadastrado.<br>
        <small class="help-block"><i>Escolha uma das opções abaixo, ou utilize o menu ao lado para continuar...</i></small>  
      </p>
      <p>
        <a href="new-video-admin.php" class="btn btn-success">Cadastrar novo vídeo</a>
        <a href="admin.php" class="btn btn-default">Início</a>
      </p>
    </div>
